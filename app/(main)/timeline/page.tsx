    ...
    <main className="mx-auto w-full max-w-[1200px] border-x border-black px-6 py-10 sm:px-10 sm:py-14">
      <header className="border-b border-black pb-8">
        ...
        <p className="mt-3 max-w-3xl text-base leading-relaxed text-black/75">
          This timeline situates our project within major U.S. events, including
          mass shootings, presidential elections, the COVID-19 pandemic, and key
          police accountability moments, to show how national context shaped
          public discourse on policing and violence.
        </p>
      </header>
