        ...
        <div className="space-y-4 border border-black px-4 py-4">
          ...
          <div>
            ...
            <p className="mt-2 text-sm leading-relaxed text-black/80">
              A choropleth map was chosen because geographic distribution is
              best communicated through spatial encoding - color intensity on a
              map immediately signals regional patterns in a way a table or bar
              chart cannot. This map shades each U.S. state by the percentage
              of police shootings flagged as mental-illness-related, ranging
              from light blue (lower rates) to dark blue (higher rates). States
              like New Hampshire (42.4%), South Dakota (34.3%), and New York
              (31.7%) appear darkest, while Kentucky (11.2%), Mississippi
              (12.2%), and Colorado (12.5%) appear lightest, with the national
              average sitting around 20%.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2 text-sm leading-relaxed text-black/80">
              ...
              health crisis intervention infrastructure that routes more calls
              to police, or simply more rigorous record-keeping. The map does
              not tell us that mental illness is more prevalent in these states
              - it tells us that police encounters labeled
              mental-illness-related are more common there, which may be as much
              a product of policy and reporting culture as of underlying social
              conditions.
            </p>
          </div>
        </div>
      ...
      <article className="space-y-4 border-t border-black pt-8">
        ...
        <div className="space-y-4 border border-black px-4 py-4">
          ...
          <div>
            ...
            <p className="mt-2 text-sm leading-relaxed text-black/80">
              A horizontal bar chart was used here to make direct
              state-by-state comparison easy to read - horizontal orientation
              accommodates state abbreviation labels cleanly and allows viewers
              to rank states at a glance. The chart filters to states with at
              least 20 incidents to avoid misleading rates from tiny sample
              sizes. The top states (NH, SD, NY, MA, MN) have MI rates between
              27-42%, while the bottom states (KY, MS, CO, MT, ID) cluster
              between 11-13%.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2 text-sm leading-relaxed text-black/80">
              ...
              partly a function of where the incident happened and who is
        ...
        <div className="space-y-4 border border-black px-4 py-4">
          ...
          <div>
            ...
            <p className="mt-2 text-sm leading-relaxed text-black/80">
              ...
              the mental illness label varies across the different types of
              threat a subject was perceived to pose. The chart reveals a clear
              pattern: incidents coded as point (25.8%) and threat (23.9%) are
              most associated with mental illness, followed by attack (20.5%)
              and move (19%). At the bottom, flee (6.8%) and accident (0%) have
              the lowest MI rates.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2 text-sm leading-relaxed text-black/80">
              ...
              mental health crisis deliberately provokes a police response
              without necessarily fleeing or launching a physical attack. The
              high MI rate for point and threat categories suggests that
              individuals flagged as mentally ill are more likely to be standing
              their ground or making a threatening gesture than actively
              attacking or running. For this project, this is a key finding:
              mental illness in police shooting data is not randomly distributed
              across threat types, but concentrated in specific behavioral
              profiles that likely reflect crisis rather than criminal intent.
            </p>
          </div>
        </div>
      </article>
        ...
        <div className="space-y-4 border border-black px-4 py-4">
          ...
          <div>
            ...
            <p className="mt-2 text-sm leading-relaxed text-black/80">
              ...
              car (8%) or by other means (7.8%). Subjects fleeing on foot fell
              in between at 10.1%.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2 text-sm leading-relaxed text-black/80">
              ...
              people who are not evading law enforcement but are instead in
              acute psychiatric distress. For a project examining police
              violence, this raises urgent questions about whether lethal force
              is an appropriate response to what are often mental health
              emergencies, and whether better crisis intervention training or
              co-responder programs could prevent these deaths.
            </p>
          </div>
        </div>
      </article>
        ...
        <div className="space-y-4 border border-black px-4 py-4">
          ...
          <div>
            ...
            <p className="mt-2 text-sm leading-relaxed text-black/80">
              ...
              MI association rate in the dataset - suggesting that individuals
              in mental health crisis may brandish fake guns in ways consistent
              with suicidal behavior. The relatively lower rate for actual guns
              (16.8%) compared to replicas and knives further supports this
              interpretation. For this project, these patterns collectively
              argue that mental-illness-related police shootings form a distinct
